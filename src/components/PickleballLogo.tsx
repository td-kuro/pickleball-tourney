...
// Simple pickleball-ball mark: a yellow-to-green sphere (tying the two brand
...
export function PickleballLogo({ size = 32, className }: PickleballLogoProps) {
  ...
  return (
    ...
    >
      ...
      <circle cx="24" cy="24" r="21" fill="url(#pickleball-logo-gradient)" stroke="var(--brand-yellow-dark)" strokeWidth="1.5" />
      {holes.map(([cx, cy]) => (
